                    ...
                    <div className="nav-dis">
                        ...
                        <div className="links-con">
                            <ul className={close ? "slider" : "ul-style"}>
                                <li className='li-style li-one'><a href="/package" className='a-style'>Features</a></li>
                                <li className='li-style'><a href="/tariff" className='a-style'>Pricing</a></li>
                                <li className='li-style'><a href="/#testimonial" className='a-style'>Download</a></li>
                                <li className='li-style'><a href="/joinus" className='a-style'>Blogs</a></li>
                                <li className='li-style'><a href="/payment" className='a-style'>About Us</a></li>
